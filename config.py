...
ASSUSERNAME = getenv("ASSUSERNAME" , "II_RADHE_ll")
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 17000))
LOGGER_ID = int(getenv("LOGGER_ID", -1002309133745))
OWNER_ID = int(getenv("OWNER_ID", 6726372149))
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Radhe0007/HIMANI-X-RADHE",)
